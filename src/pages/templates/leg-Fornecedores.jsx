    ...
    <div className="template-page min-h-screen bg-gray-50 antialiased">
      ...
      <header className="relative bg-gradient-to-br from-orange-600 via-orange-700 to-red-800 text-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 md:px-12 py-6 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="bg-white/10 p-2 rounded-2xl"><Package size={28} /></div>
            <div>
          ...
          <div className="flex items-center gap-4">
            ...
            <button onClick={() => setPedidoAberto(true)} className="relative flex items-center gap-2 bg-white/10 border border-white/20 px-4 py-2 rounded-2xl hover:bg-white/20 transition text-sm">
          ...
          <div className="max-w-4xl">
            ...
            <div className="relative max-w-3xl">
              ...
              <input
                ...
                className="w-full pl-11 pr-10 py-3.5 bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl placeholder-orange-300 focus:outline-none focus:ring-2 focus:ring-yellow-400 transition"
              />
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 -mt-10 relative z-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <div key={i} className="bg-white rounded-2xl p-4 shadow-lg flex items-center gap-3 hover:shadow-2xl transition">
              <div className="bg-orange-100 p-2 rounded-2xl"><b.icon size={20} className="text-orange-600" /></div>
              <div>
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {produtosFiltrados.map((p) => {
            ...
            return (
              <div key={p.id} className="bg-white rounded-2xl p-5 shadow-md shadow-black/5 hover:shadow-2xl transition-all group">
                <div className="bg-orange-50 rounded-2xl h-32 flex items-center justify-center mb-4">
                ...
                {noPedido ? (
                  <div className="w-full mt-4 flex items-center justify-between bg-orange-50 border border-orange-200 rounded-2xl px-3 py-2">
                  ...
                  <button onClick={() => addPedido(p)} className="w-full mt-4 bg-orange-600 text-white py-2 rounded-2xl text-sm font-medium hover:bg-orange-700 transition flex items-center justify-center gap-1">
        ...
        <div className="fixed inset-0 z-50" onClick={() => setPedidoAberto(false)}>
          ...
          <div className="absolute right-0 top-0 h-full w-full max-w-md bg-white shadow-2xl flex flex-col animate-slide-in-right" onClick={e => e.stopPropagation()}>
            <div className="flex items-center justify-between p-5 border-b">
              ...
              <button onClick={() => setPedidoAberto(false)} className="p-1.5 hover:bg-gray-100 rounded-2xl"><X size={18} /></button>
            </div>
            ...
            {pedido.length > 0 && (
              <div className="border-t p-5 space-y-3">
                ...
                }} className="w-full bg-orange-600 text-white py-3 rounded-2xl font-semibold hover:bg-orange-700 transition">
                  Enviar Pedido
                </button>
              </div>
            )}
      ...
      <Modal open={orcamentoModal} onClose={() => setOrcamentoModal(false)} title="Solicitar Orçamento">
        <div className="space-y-3">
          <input type="text" placeholder="Nome *" value={formOrcamento.nome} onChange={e => setFormOrcamento({ ...formOrcamento, nome: e.target.value })}
            className="w-full px-4 py-2.5 border rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-orange-500" />
          ...
          <textarea placeholder="Lista de materiais ou observações" rows={4} value={formOrcamento.mensagem} onChange={e => setFormOrcamento({ ...formOrcamento, mensagem: e.target.value })}
            className="w-full px-4 py-2.5 border rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 resize-none" />
        </div>
        <button onClick={handleOrcamento} className="w-full mt-4 bg-orange-600 text-white py-3 rounded-2xl font-semibold hover:bg-orange-700 transition flex items-center justify-center gap-2">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center text-white">
            {[
              ...
              <div key={i} className="bg-white/10 rounded-2xl p-6 backdrop-blur-sm hover:bg-white/20 transition">
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 py-16">
        <div className="bg-gradient-to-r from-orange-600 to-red-600 rounded-3xl p-10 md:p-16 text-white text-center">
          ...
          <p className="text-orange-100 max-w-3xl mx-auto mb-8">
            Envie sua lista de materiais e receba uma proposta com preços exclusivos em até 1 hora.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <button onClick={() => setOrcamentoModal(true)} className="bg-white text-orange-700 px-8 py-3.5 rounded-2xl font-semibold hover:shadow-2xl transition flex items-center gap-2">
