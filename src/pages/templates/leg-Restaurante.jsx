...
export default function Restaurante() {
  ...
  return (
    <div className="template-page min-h-screen bg-stone-50 antialiased">
      ...
      {/* Destaques */}
      <section className="max-w-6xl mx-auto px-6 md:px-12 -mt-16 relative z-10">
      ...
      {/* Cardápio */}
      <section ref={cardapioRef} className="max-w-6xl mx-auto px-6 md:px-12 py-20">
        ...
        {totalItens > 0 && (
          <button
            ...
            className="fixed bottom-6 right-6 z-40 bg-amber-600 text-white px-6 md:px-12 py-3 rounded-full shadow-xl shadow-amber-600/30 font-semibold hover:bg-amber-700 transition flex items-center gap-2"
          >
