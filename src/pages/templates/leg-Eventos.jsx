    ...
    <div className="template-page min-h-screen bg-white antialiased">
      ...
      <header className="relative bg-gradient-to-br from-pink-600 via-rose-600 to-purple-700 text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 md:px-12 py-24 md:py-32">
          ...
          <div className="mt-14 grid grid-cols-4 gap-4 max-w-2xl">
            {[
      ...
      {/* Filtros */}
      <section ref={eventosRef} className="max-w-7xl mx-auto px-6 md:px-12 py-8">
              ...
              <div key={ev.id} className="group relative bg-gradient-to-br from-pink-500 to-purple-600 rounded-2xl p-8 text-white overflow-hidden hover:shadow-2xl transition-all">
                ...
                <div className="flex items-center justify-between mt-6">
                  ...
                  <button
                    ...
                    className={`px-6 md:px-12 py-2 rounded-full font-semibold transition flex items-center gap-2 text-sm ${
        ...
        <div className="max-w-3xl mx-auto px-6 md:px-12 text-center text-white">
          ...
          <div className="flex gap-3 max-w-md mx-auto">
            ...
            <button
              ...
              className="bg-yellow-400 text-pink-800 px-6 md:px-12 py-3 rounded-full font-semibold hover:bg-yellow-300 transition"
            >
              Assinar
            </button>
          </div>
