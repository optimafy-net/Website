    ...
    <div className="template-page min-h-screen bg-white antialiased">
      ...
      <header className="relative bg-gradient-to-br from-teal-900 via-emerald-900 to-green-900 text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 md:px-12 py-24 md:py-32">
          ...
          {/* Rastreamento */}
          <div className="mt-12 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 max-w-3xl">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                disabled={buscando}
                className="bg-emerald-500 hover:bg-emerald-600 px-6 md:px-12 py-3 rounded-2xl font-medium transition flex items-center gap-2 text-sm disabled:opacity-50"
              >
                {buscando ? (
      ...
      {/* Serviços */}
      <section ref={servicosRef} className="max-w-7xl mx-auto px-6 md:px-12 py-20">
