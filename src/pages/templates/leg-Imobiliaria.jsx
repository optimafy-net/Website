...
export default function Imobiliaria() {
  ...
  return (
    <div className="template-page min-h-screen bg-gray-50 antialiased">
          ...
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <button onClick={() => document.getElementById('listagem')?.scrollIntoView({ behavior: 'smooth' })}
                className="bg-sky-500 hover:bg-sky-600 rounded-2xl px-6 md:px-12 py-3 font-semibold transition flex items-center justify-center gap-2 text-sm">
      ...
      {/* Listagem */}
      <section id="listagem" className="max-w-7xl mx-auto px-6 md:px-12 pb-16">
