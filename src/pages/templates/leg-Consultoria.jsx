    ...
    <div className="template-page min-h-screen bg-white antialiased">
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 py-20">
        <div className="text-center mb-14">
          ...
          <p className="text-gray-500 mt-3 max-w-3xl mx-auto">Soluções completas para cada fase do seu negócio</p>
        </div>
      ...
      {/* Cases */}
      <section id="cases" className="max-w-7xl mx-auto px-6 md:px-12 py-20">
        <div className="text-center mb-14">
