        ...
        <div className={`bg-gradient-to-r ${banners[bannerIdx].cor} rounded-2xl p-8 md:p-12 text-white relative overflow-hidden transition-all duration-500`}>
          ...
          <div className="relative">
            ...
            <button
              ...
              className="bg-white text-green-700 px-6 md:px-12 py-2.5 rounded-full font-semibold hover:shadow-2xl transition flex items-center gap-2"
            >
            ...
            return (
              <div key={p.id} className="bg-white rounded-2xl p-4 hover:shadow-2xl transition-shadow group relative overflow-hidden">
                ...
                <div className="flex items-center gap-1 mt-2">
                  ...
                  <span className="text-xs text-gray-400 ml-1">({Math.floor((p.id * 37) % 200 + 50)})</span>
                </div>
                {noCarrinho ? (
